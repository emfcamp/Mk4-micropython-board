...
//
//*****************************************************************************
#define VTABLE_START_ADDRESS    0x00010000
...
// GPIO port. This applies to for FORCED_UPDATE_PORT.
//
...
//
//*****************************************************************************
#define FORCED_UPDATE_PERIPH    SYSCTL_RCGCGPIO_R11

//*****************************************************************************
//
// The GPIO port to check for a forced update.  This will be one of the
// GPIOx values, where "x" is replaced with the port name (such as B). The
// value of "x" should match the value of "x" for FORCED_UPDATE_PERIPH.
//
// Depends on: ENABLE_UPDATE_CHECK
// Exclusive of: None
// Requires: None
//
//*****************************************************************************
#define FORCED_UPDATE_PORT      GPIOM
...
// the locking mechanism will not be used.
//
// Depends on: ENABLE_UPDATE_CHECK
// Exclusive of: None
// Requires: None
//
//*****************************************************************************
//#define FORCED_UPDATE_KEY       0x4C4F434B
...
//           UARTx, UART_RXPIN_CLOCK_ENABLE, UART_RXPIN_BASE,
...
// The value of the define is based on the GPIO Port on which the UART RX pin
// is mapped. When GPIO Port A has the UART RX pin then the value of the
// define is 0.
//
...
// Requires: SSI_CLOCK_ENABLE, SSIx, SSI_CLKPIN_CLOCK_ENABLE,
...
//               UART_ENABLE_UPDATE, USB_ENABLE_UPDATE
// Requires: I2C_SLAVE_ADDR, I2C_CLOCK_ENABLE, I2Cx,
...
//
//*****************************************************************************
//#define ENET_BOOTP_SERVER       "msp432e4"
...
// vendor ID.  Change this to the vendor ID you have been assigned by the
// USB-IF.
//
...
//
//*****************************************************************************
//#define USB_MUX_PERIPH          SYSCTL_RCGCGPIO_R7

//*****************************************************************************
//
// Specifies the GPIO port containing the pin which is used to select between
// USB host and device modes.  The value is of the form GPIOx, where x
// represents the required GPIO port.
//
// Depends on: USB_ENABLE_UPDATE, USB_HAS_MUX
// Exclusive of: None
// Requires: None
...
// is of the form GPIOx, where x represents the required GPIO port.
//
// Depends on: USB_ENABLE_UPDATE, USB_VBUS_CONFIG
// Exclusive of: None
// Requires: None
...
// be one of the SYSCTL_RCGCGPIO_Rx values, where the Rx represents the
// required GPIO port.
//
// Depends on: CAN_ENABLE_UPDATE
// Exclusive of: None
...
//
//*****************************************************************************
//#define CAN_RX_PERIPH           SYSCTL_RCGCGPIO_R0

//*****************************************************************************
//
// The GPIO port used to configure the CAN0 Rx pin.  This will be one of the
// GPIOx values, where "x" is replaced with the port name (such as
...
// Depends on: I2C_ENABLE_UPDATE
// Exclusive of: None
// Requires: CAN_RX_PERIPH, CAN_RX_PORT and CAN_RX_PIN
//
//*****************************************************************************
...
//
//*****************************************************************************
//#define CAN_TX_PERIPH           SYSCTL_RCGCGPIO_R0
...
// Depends on: CAN_ENABLE_UPDATE
// Exclusive of: None
// Requires: CAN_TX_PERIPH, CAN_TX_PORT and CAN_TX_PIN
//
//*****************************************************************************
